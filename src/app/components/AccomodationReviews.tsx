    ...
    return (
        <div>
            ...
            <div className='relative'>
                ...
                <button className='absolute -left-5 top-[50%] w-10 h-10 -translate-y-[50%] rounded-[50%] shadow-[0_3px_10px_rgb(0,0,0,0.2)] bg-white z-10 flex items-center justify-center' ref={navigationPrevRef}><IconChevronLeft stroke={2} /></button>
                <button className='absolute -right-5 top-[50%] w-10 h-10 -translate-y-[50%] rounded-[50%] shadow-[0_3px_10px_rgb(0,0,0,0.2)] bg-white z-10 flex items-center justify-center' ref={navigationNextRef}><IconChevronRight stroke={2} /></button>
            </div>
