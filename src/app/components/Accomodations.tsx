    ...
    return (
        <div className='flex flex-col w-full'>
            <div className='mb-3 flex items-center w-full'>
                ...
                <div className='flex items-center bg-gray-100 border border-color-200 px-0.5 py-0.5 rounded-2xl text-sm'>
                    <div className={`${(grid ? '' : 'bg-white border rounded-xl')} px-2 py-0.5 border-gray-400 hover:cursor-pointer`} onClick={() => setGrid(false)}>Lijst</div>
                    <div className={`${(grid ? 'bg-white border rounded-xl' : '')} px-2 py-0.5 border-gray-400 hover:cursor-pointer`} onClick={() => setGrid(true)}>Raster</div>
                </div>
            </div>
